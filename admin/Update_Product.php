...
<div class="row register">
  <div class="col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 ">
      <form id="f1" action="Update_Product.php?id=<?php echo $product_id; ?>" method="post" enctype="multipart/form-data">
        Enter Product Name<input type="text" class="form-control" name="name" placeholder="Full Name" value='<?php echo $rs['product_name']; ?>' name="name"><br><br>
		...
		ENTER QUANTITY: <input type="number" value='<?php echo $rs['product_quantity']; ?>' min="0" name="qty"><br><br>
...
$c_img_temp=$_FILES["file1"]["tmp_name"];	
if($product_img==null)
{
	$product_img = $rs['product_img'];
}
else
{
	$product_img= 'uploads/'.$_FILES['file1']['name'];
}
$product_category=$_POST['cat'];
$product_quantity=$_POST['qty'];


	move_uploaded_file($c_img_temp,$product_img);
